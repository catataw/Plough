...
export default Ember.Component.extend({
    ...
    doDelete:function(){
      ...
      this.sendAction("todeleteGatheringPlan",this.get("showItem"));
    },
    ...
    confirm:function(){
      ...
      if(this.get('showItem').id){
        this.sendAction("tomodifyGatheringPlan",this.get("showItem"));
      }
      else{
        this.sendAction("touploadGatheringPlan",this.get("showItem"));
      }
    },
    cancle:function(){
      this.set('isStatic',true);
